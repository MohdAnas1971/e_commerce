...
import com.example.ecommerce.presentation.theme.DealOfTheDay
...
@Composable
fun DealOfTheDayCard(remainingTime: String = "22h 55m 20s", containerColors: Color= DealOfTheDay) {
    Log.d("ui","DealOfTheDayCard")
    ...
    Card(
        ...
        Row(
            ...
            Column {
                Text("Deal of the Day", style = MaterialTheme.typography.headlineSmall)
                ...
                Row(
                    ...
                    Text("${remainingTime.format(formatter)} remaining")
                }
